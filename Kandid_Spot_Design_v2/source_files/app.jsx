...
const AREAS = [
{ value: "Hongdae / Yeonnam", sub: "youth · indie · late night", img: "img/area-hongdae.jpg" },
{ value: "Seongsu", sub: "cafes · brands · workshops", img: "img/area-seongsu.jpg" },
{ value: "Anguk / Bukchon", sub: "tradition · small lanes", img: "img/area-bukchon.jpg" },
{ value: "Myeongdong / Euljiro", sub: "central food + shopping", img: "img/area-myeongdong.jpg" },
{ value: "Itaewon / Hannam", sub: "global food + design", img: "img/area-itaewon.jpg" },
{ value: "Gangnam / Sinsa", sub: "polished · trendy · busy", img: "img/area-gangnam.jpg" }];


const TIMES = [
{ value: "30–60 min", sub: "I arrived early", img: "img/time-1.jpg" },
{ value: "1–2 hours", sub: "a quick nearby loop", img: "img/time-2.jpg" },
{ value: "2–3 hours", sub: "a relaxed route", img: "img/time-3.jpg" },
{ value: "Half day", sub: "the long way around", img: "img/time-4.jpg" }];


const MOODS = [
{ value: "Local food", sub: "meals locals save", peeks: ["img/mood-food-1.jpg", "img/mood-food-2.jpg", "img/mood-food-3.jpg"] },
{ value: "Cafes & dessert", sub: "coffee, bakery, sweets", peeks: ["img/mood-cafe-1.jpg", "img/mood-cafe-2.jpg", "img/mood-cafe-1.jpg"] },
{ value: "Drinks & night", sub: "bars, lights, late", peeks: ["img/mood-drinks-1.jpg", "img/mood-drinks-2.jpg", "img/mood-drinks-3.jpg"] },
{ value: "Shop & browse", sub: "books, small brands", peeks: ["img/mood-shop-1.jpg", "img/mood-shop-2.jpg", "img/mood-shop-3.jpg"] },
{ value: "Culture & activities", sub: "exhibits, classes", peeks: ["img/mood-culture-1.jpg", "img/mood-culture-2.jpg", "img/mood-culture-3.jpg"] },
{ value: "Walks & views", sub: "parks, lanes, photos", peeks: ["img/mood-walks-1.jpg", "img/mood-walks-2.jpg", "img/mood-walks-1.jpg"] }];


// Route results vary by mood — keep it small but real-feeling.
const ROUTES = {
  "Local food": [
  { name: "Yeonnam Galmaegisal", type: "backstreet bbq", stay: "55 min", walk: "5 min walk", why: "ten-seat spot tucked behind the main strip; older neighborhood crowd.", img: "img/mood-food-1.jpg" },
  { name: "Gyeongui Line Forest", type: "park lane", stay: "20 min", walk: "8 min walk", why: "old rail-line turned linear park; the cooling-off stretch.", img: "img/mood-walks-1.jpg" },
  { name: "Café Pause", type: "tiny cafe", stay: "30 min", walk: "4 min walk", why: "single-origin, no laptops, big front window — a real sit-down.", img: "img/mood-cafe-1.jpg" },
  { name: "Record Shop Donguri", type: "vinyl shop", stay: "20 min", walk: "—", why: "korean indie + city pop; the owner will play whatever you ask.", img: "img/mood-shop-1.jpg" }],

  "Cafes & dessert": [
  { name: "Felt Coffee", type: "tasting bar", stay: "35 min", walk: "—", why: "filter flight on a marble counter; minimal, focused.", img: "img/mood-cafe-1.jpg" },
  { name: "Gyeongui Line Forest", type: "park lane", stay: "15 min", walk: "6 min walk", why: "the walking stretch between cafes.", img: "img/mood-walks-1.jpg" },
  { name: "Eclair de Génie", type: "patisserie", stay: "25 min", walk: "7 min walk", why: "the éclair pull is for real; sit upstairs near the window.", img: "img/mood-cafe-2.jpg" },
  { name: "Anthracite", type: "warehouse cafe", stay: "30 min", walk: "9 min walk", why: "old shoe-factory; concrete + greenery, ends the loop slow.", img: "img/mood-food-3.jpg" }],

  "Drinks & night": [
  { name: "Mortar", type: "natural wine", stay: "60 min", walk: "—", why: "smaller-producer list; the bartender pours generously.", img: "img/mood-drinks-1.jpg" },
  { name: "Yeonnam back lanes", type: "neighborhood walk", stay: "15 min", walk: "5 min walk", why: "low-rise residential; the right vibe between drinks.", img: "img/area-hongdae.jpg" },
  { name: "Hidden Trash", type: "listening bar", stay: "45 min", walk: "8 min walk", why: "vinyl-only, small room, no menu — order what they pour.", img: "img/mood-drinks-2.jpg" },
  { name: "Late noodle, Hyodo", type: "supper", stay: "30 min", walk: "6 min walk", why: "open until 3am; the close-out bowl.", img: "img/mood-food-2.jpg" }]
...
// Fills its container with a cover-fit photo.
...
function Folder({ option, idx, selected, onClick }) {
  ...
  return (
    <button
      ...
      onClick={onClick}
    >
      {/* Photos peeking out from above the folder */}
...
function Loading({ area }) {
  ...
  const cards = [
  { x: "10%", y: "20%", rot: -8, img: "img/load-1.jpg" },
  { x: "30%", y: "60%", rot: 6, img: "img/load-2.jpg" },
  { x: "55%", y: "10%", rot: -3, img: "img/load-3.jpg" },
  { x: "78%", y: "55%", rot: 9, img: "img/load-4.jpg" }];
  ...
  return (
    <div className="ks-map-frame">
      ...
      <div className="ks-float-card">
          ...
          <Photo src={stops[activeIdx].img} alt={stops[activeIdx].name}
        style={{ width: 56, height: 56, borderRadius: 12, border: "1.5px solid var(--ks-rule)", flexShrink: 0 }} />
        </div>
      }
    </div>);
